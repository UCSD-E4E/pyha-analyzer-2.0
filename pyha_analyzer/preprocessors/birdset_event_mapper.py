"""
Event mapping method from BirdSet. Essentially chunks data around detected events and adds them to the dataset
"""
...
class XCEventMapping:
    ...
    def __call__(self, batch):
        ...
        # print(f"New batch, of length {len(new_batch)} {new_batch}")
        return new_batch
