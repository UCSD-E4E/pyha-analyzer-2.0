...
class MelSpectrogramPreprocessors(PreProcessorBase):
    def __init__(self, duration=5): #TODO Suppose we pass data augmentations through here?
    ...
    def __call__(self, batch):
        ...
        for item_idx in range(len(batch["audio"])):
            ...
            new_audio.append(np.array(
                    pillow_transforms(librosa.feature.melspectrogram(
